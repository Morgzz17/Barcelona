...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Jun-2024 às 17:58
...
--
CREATE DATABASE IF NOT EXISTS `fc_barcelona` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `fc_barcelona`;
...
(1, 'Marc-André ter Stegen', 33, 1, 'GK', 'German'),
...
(24, 'João Félix', 24, 14, 'SA', 'Portuguese'),
